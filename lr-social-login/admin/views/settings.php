                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('Turn on, if you would like to prompt these users for their email address in a separate pop-up', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <div>
                    ...
                    <div class="lr-row">
                        ...
                        <div>
                            <h4>
                                ...
                                <span class="lr-tooltip" data-title="<?php _e('During account creation, it automatically adds a separator between the user\'s first name and last name', 'LoginRadius'); ?>">
                                    <span class="dashicons dashicons-editor-help"></span>
                                </span>
                            </h4>
                            <label>
                        ...
                        <div>
                            ...
                            <div id="loginRadiusDefaultStatus" class="lr-row">
                                <h5>
                                    ...
                                    <span class="lr-tooltip" data-title="<?php _e('Select whether you would like the user to be set to an active or inactive user after the initial registration process', 'LoginRadius'); ?>">
                                        <span class="dashicons dashicons-editor-help"></span>
                                    </span>
                                </h5>
                                <label>
