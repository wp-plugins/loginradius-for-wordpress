...
if (!class_exists('LR_Social_Login')) {
    ...
    class LR_Social_Login {
        ...
        private function load_dependencies() {
            ...
            require_once( LOGINRADIUS_PLUGIN_DIR.'widgets/loginradius-social-login-widget.php' );
            require_once( LOGINRADIUS_PLUGIN_DIR.'widgets/loginradius-social-linking-widget.php' );
