...
if ( !class_exists( 'Login_Radius_Common' ) ) {
    ...
    class Login_Radius_Common {
        ...
        public static function load_login_script( $isLinkingWidget = false ) {
            global $loginRadiusSettings;
            $loginRadiusSettings['LoginRadius_apikey'] = isset( $loginRadiusSettings['LoginRadius_apikey'] ) ? trim( $loginRadiusSettings['LoginRadius_apikey'] ) : '';
            ...
            LoginRadius_SocialLogin.util.ready(function() {
                ...
                $ui.interfacesize = '';
                $ui.apikey = "<?php echo $loginRadiusSettings['LoginRadius_apikey'] ?>";
