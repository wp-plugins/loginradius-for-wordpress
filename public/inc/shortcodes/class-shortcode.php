...
if ( !class_exists( 'Login_Radius_Shortcode' ) ) {
    ...
    class Login_Radius_Shortcode {
        ...
        public static function linking_widget_shortcode() {
            ...
            if ( !( $loginRadiusObject->loginradius_validate_key( trim( $loginRadiusSettings['LoginRadius_apikey'] ) ) && $loginRadiusObject->loginradius_validate_key( trim( $loginRadiusSettings['LoginRadius_secret'] ) ) ) ) {
