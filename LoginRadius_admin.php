    ...
    <div class="page-header" id="tabs">
       <!-- <img alt='LoginRadius' src="//cache.LoginRadius.com/icons/v1/thumbs/32x32/more.png" class="header-img"/>-->
        <ul class="nav-tab-wrapper">
            <li><h2 class="nav-tab-wrapper"><a href="#tabs-3"><?php _e('LoginRadius API Settings', 'LoginRadius') ?></a></h2></li>
		
            <li><h2 class="nav-tab-wrapper"><a href="#tabs-1"><?php _e('Social Login', 'LoginRadius') ?> </a></h2></li>
            <li><h2 class="nav-tab-wrapper"><a href="#tabs-2"><?php _e('Social Share', 'LoginRadius') ?></a></h2></li>
