 ...
 */	
  public static function LoginRadius_front_css_custom_page() {
    wp_register_style('LoginRadius-plugin-frontpage-css', plugins_url('css/lrstyle.css', __FILE__), array(), '1.0.0', 'all');
...
function LoginRadius_options_page_style() {
  $style_location = apply_filters('LoginRadius_files_uri', plugins_url('css/options-page.css', __FILE__));
...
function LoginRadius_admin_css_custom_page() {
  wp_register_style('LoginRadius-plugin-page-css', plugins_url('css/lrstyle.css', __FILE__), array(), '1.0.0', 'all');
