...
if ( !class_exists( 'Login_Radius' ) ) {
    ...
    class Login_Radius {
        ...
        private function load_dependencies() {
            ...
            require_once('widgets/loginradius-horizontal-share-widget.php');
            require_once('widgets/loginradius-vertical-share-widget.php');
...
register_activation_hook( __FILE__, array('Login_Radius', 'install') );
